    ...
    <div class="w-full max-w-lg">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="px-6 py-5 space-y-4">
                ...
                {{-- Action --}}
                <a href="#" x-data
                   @click.prevent="if(await $store.confirmModal.open({title:'Mulai Ujian',message:'Mulai ujian sekarang? Timer akan langsung berjalan.',confirmText:'Mulai'})) window.location.href='{{ route('ujian.mengerjakan', $sesiPeserta->id) }}'"
                   class="w-full flex items-center justify-center gap-2 bg-blue-700 hover:bg-blue-800 text-white text-sm font-bold px-6 py-3 rounded-xl transition-colors">
