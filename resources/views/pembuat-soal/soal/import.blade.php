...
<div class="space-y-6" x-data="importSoal()">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        {{-- Tab Selector --}}
        <div class="flex flex-wrap rounded-lg bg-gray-100 p-1 mb-6 w-fit">
        ...
        {{-- Info: soal import akan belum terverifikasi --}}
        <div class="mb-4 bg-amber-50 border border-amber-200 rounded-lg p-3 text-sm text-amber-800">
            <strong>Catatan:</strong> Soal yang diimport akan berstatus <em>belum diverifikasi</em> dan perlu diverifikasi oleh admin/dinas sebelum dapat digunakan dalam ujian.
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="{{ route('pembuat-soal.soal.import.template.word') }}"
            ...
            <a href="{{ route('pembuat-soal.soal.import.template.zip') }}"
    ...
    return {
        ...
        async startUpload() {
            ...
            const url = this.activeTab === 'zip'
                ? '{{ route("pembuat-soal.soal.import.zip") }}'
                : '{{ route("pembuat-soal.soal.import.word") }}';
        ...
        async checkStatus() {
            ...
            try {
                const response = await fetch(`{{ url('pembuat-soal/soal/import/status') }}/${this.jobId}`, {
