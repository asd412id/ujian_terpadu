...
<div class="max-w-4xl mx-auto space-y-5">
    ...
    <div class="bg-indigo-50 border border-indigo-200 rounded-xl p-5">
        ...
        <div class="formatted-content prose-content text-gray-800 mathjax-process">{!! \App\Support\HtmlDisplay::render($soal->narasi->konten) !!}</div>
    </div>
    @endif
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
        ...
        <div class="formatted-content prose-content text-gray-800 mathjax-process">{!! \App\Support\HtmlDisplay::render($soal->pertanyaan) !!}</div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
        ...
        <div class="space-y-2">
            ...
            <div class="flex items-start gap-3 p-3 rounded-lg {{ $opsi->is_benar ? 'bg-green-50 border border-green-200' : 'bg-gray-50' }}">
                ...
                <div class="flex-1">
                    @if($opsi->teks)
                    <p class="formatted-content text-sm text-gray-800 prose-content mathjax-process">{!! \App\Support\HtmlDisplay::render($opsi->teks) !!}</p>
                    @endif
                    @if($opsi->gambar)
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
        ...
        <div class="p-3 bg-amber-50 border border-amber-200 rounded-lg">
            <div class="formatted-content text-sm text-gray-800 prose-content mathjax-process">{!! \App\Support\HtmlDisplay::render($soal->pembahasan) !!}</div>
        </div>
        @endif
    </div>
    @endif
