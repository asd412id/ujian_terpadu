...
<div class="space-y-5">
    ...
    <div class="card bg-teal-50 border border-teal-200">
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="font-semibold text-teal-800">{{ $soalDitugaskan }} soal ditugaskan kepada Anda</p>
                <p class="text-xs text-teal-600">Soal dari admin yang bisa Anda akses dan kelola di Bank Soal</p>
            </div>
        </div>
    </div>
    @endif
