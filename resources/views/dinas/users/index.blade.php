            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-5 py-3 text-center hidden md:table-cell">
                        @php
                            $roleColors = ['admin_dinas' => 'blue', 'operator_sekolah' => 'green', 'pengawas' => 'amber', 'admin' => 'purple'];
                ...
                @empty
                <tr><td colspan="6" class="px-5 py-10 text-center text-gray-400">Belum ada pengguna.</td></tr>
                @endforelse
            </tbody>
        </table>
        @if($users->hasPages())
