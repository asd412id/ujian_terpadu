...
<div class="max-w-4xl mx-auto space-y-5" x-data="{ showNav: false }">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('dinas.soal.export.word', ['kategori_soal_id' => request('kategori')]) }}"
            ...
            <div class="p-5 space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="flex items-start gap-2.5 px-3 py-2 rounded-lg {{ $opsi->is_benar ? 'bg-green-50 border border-green-200' : 'bg-gray-50' }}">
                        ...
                        {{-- PGK: checkbox icon --}}
                        @if($opsi->is_benar)
                        <span class="flex-shrink-0 w-6 h-6 rounded flex items-center justify-center bg-green-500">
                        ...
                        @else
                        <span class="flex-shrink-0 w-6 h-6 rounded border-2 border-gray-300 flex items-center justify-center"></span>
                        @endif
                        @else
