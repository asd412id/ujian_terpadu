...
<div class="space-y-5 max-w-2xl" x-data="{ mode: 'update', confirm_replace: false }">
    ...
    <div class="card bg-blue-50 border-blue-200">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <a href="{{ route('sekolah.peserta.import.template') }}"
    ...
    @if(session('job_id'))
    @php
        $importJobStatusUrl = route('sekolah.peserta.import.status', session('job_id'));
        $importRedirectUrl  = route('sekolah.peserta.index');
    @endphp
        ...
        <div>
            ...
            <div class="space-y-2">
                ...
                <label class="flex items-start gap-3 p-3 border rounded-xl cursor-pointer hover:bg-gray-50 transition-colors"
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-0.5">
                            Seluruh peserta sekolah ini dihapus, kemudian diganti data dari file Excel.
                        </p>
                    </div>
                </label>
            </div>
            ...
            <div x-show="mode === 'replace_all'" x-cloak
                ...
                <label for="confirm_replace" class="text-xs text-red-700 cursor-pointer leading-relaxed">
                    Saya mengerti bahwa <strong>seluruh data peserta sekolah ini akan dihapus permanen</strong>
