...
@section('breadcrumb')
    <a href="{{ route('sekolah.laporan') }}" class="text-gray-500 hover:text-blue-600">Laporan Nilai</a>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <a href="{{ route('sekolah.laporan') }}" class="btn-secondary">Kembali ke Laporan</a>
    </div>
