...
@section('title', 'Detail Jawaban - ' . ($sesiPeserta->peserta?->nama ?? 'Peserta'))

@section('breadcrumb')
    <a href="{{ route('sekolah.laporan') }}" class="text-gray-500 hover:text-blue-600">Laporan</a>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">
                {{ $peserta->nis ?? $peserta->nisn }} · {{ $peserta->kelas }}
            </p>
        </div>
        <a href="{{ route('sekolah.laporan') }}" class="btn-secondary">Kembali</a>
    </div>
